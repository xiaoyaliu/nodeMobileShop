      ...
      <form data-attach-point="form">
            <div class="newAddress">
                  ...
                  <div class="address addressDetail">
                        <span>详细地址：</span>
                        <textarea class="textArea" name="address" onkeyup="value=value.replace(/[^A-Za-z\d\u4E00-\u9FA5]/g,'')" onbeforepaste="clipboardData.setData(''text'',clipboardData.getData(''text'').replace(/[^A-Za-z\d\u4E00-\u9FA5]/g,''))">{{=it.addressRs.address}}</textarea>
                  </div>
                  <div class="address">
            ...
            <div class="operate">
                  <button type="button" class="saveBtn btn-primary btn-block" onclick="save()">保存并使用</button>
            </div>
      </form>
</div>