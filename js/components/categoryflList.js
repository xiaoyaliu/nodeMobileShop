            ...
            if (param.type === "") {
                ...
                InfoChannel.getDataByAjax(url, paramAll, function (data) {
                    ...
                    if (data.data.data.length === 0) {
                        ...
                        dropload.noData();
                        if(pageSizeTo===1){
                            togetherList.html('该分类下暂无商品').css("padding-top","200px;");
                        }
                        else{
                        ...
                        togetherList.append(slTemp(data.data.data));
            ...
            //销量排序
                ...
                InfoChannel.getDataByAjax(url, paramAll, function (data) {
                    if (data.data.data.length === 0) {
                        ...
                        dropload.noData();
                        if(pageSizeSales===1){
                            salesList.html('该分类下暂无商品').css("padding-top","200px;");
                        }
                        else {
                        ...
                        salesList.append(slTemp(data.data.data));
            ...
            //价格递增排序
                ...
                InfoChannel.getDataByAjax(url, paramAll, function (data) {
                    if (data.data.data.length === 0) {
                        ...
                        dropload.noData();
                        if(pageSizePU===1){
                            priceUpList.html('该分类下暂无商品').css("padding-top","200px;");
                        }
                        else {
                        ...
                        priceUpList.append(slTemp(data.data.data));
            ...
            //价格递减排序
                ...
                InfoChannel.getDataByAjax(url, paramAll, function (data) {
                    if (data.data.data.length === 0) {
                        ...
                        dropload.noData();
                        if(pageSizePD===1){
                            priceDownList.html('该分类下暂无商品').css("padding-top","200px;");
                        }
                        else {
                        ...
                        priceDownList.append(slTemp(data.data.data));
